                                    ...
                                    <div class="row">
                                        ...
                                        <div id="product-zoom-gallery" class="product-image-gallery">
                                            ...
                                            <a class="product-gallery-item" href="#"
                                                ...
                                                <img src="{{ asset('assets/images/products/single/3-small.jpg') }}"
                                                    alt="product with model">
                                            </a>

                                            <a class="product-gallery-item" href="#"
                                                data-image="{{ asset('assets/images/products/single/4.jpg') }}"
                                                data-zoom-image="{{ asset('assets/images/products/single/4-big.jpg') }}">
                                                <img src="{{ asset('assets/images/products/single/4-small.jpg') }}"
                                                    alt="product back">
                                            </a>
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    ...
                                    <div class="product-details-action">
                                        <a href="{{ route('add_to_cart', [$product_details->id, $product_details->product_name, $product_details->product_price]) }}"
