        ...
        <div>
          ...
          <div className="page-wrapper">  
                      ...
                      <li>
                        ...
                        <ul>
                          ...
                          <div className="flex items-center"><svg width={18} height={18} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <path d="M16.5 4.5L9.00001 9.75L1.50001 4.5" stroke="#C9151B" strokeLinecap="round" strokeLinejoin="round" /></svg><a href="mailto:support@evaly.com.bd" className="ml-2">support@erp.com.bd</a>
                          </div>
                        </ul>
                      </li>
                    </ul>{/* End .top-menu */}
                    ...
                    <div className="dropdown cart-dropdown">
                      ...
                      <div className="dropdown-menu dropdown-menu-right">
                        ...
                        <div className="dropdown-cart-action">
                          ...
                          <a href="/checkout"><span>Checkout</span><i className="icon-long-arrow-right" /></a>
                        </div>{/* End .dropdown-cart-total */}
                  ...
                  <div className="header-left">
                    <nav className="main-nav">
                      <ul className="menu sf-arrows">
                        ...
                        <li>
                          <a href="shop" className="sf-with-ul">All Shop</a>
            ...
            <main className="main">
                    ...
                    <div className="row">
                      <div className="col-lg-5">
                        <div className="banner banner-big banner-overlay">
                          ...
                          <div className="banner-content banner-content-bottom">
                            <h4 className="banner-subtitle text-white"><a href="#">Trending now</a></h4>{/* End .banner-subtitle */}
                            <h3 className="banner-title text-white"><a href="#">50% discount <br />On Your Spring Wardrobe</a></h3>{/* End .banner-title */}
                      ...
                      <div className="col-lg-7">
                        <div className="banner banner-overlay">
                          ...
                          <div className="banner-content banner-content-right">
                            <h4 className="banner-subtitle text-white"><a href="#">clearance</a></h4>{/* End .banner-subtitle */}
                            <h3 className="banner-title text-white"><a href="#">Clearance It’s On <br />Up To 50% Off</a></h3>{/* End .banner-title */}
                        ...
                        <div className="row">
                          <div className="col-sm-6">
                            <div className="banner banner-overlay">
                              ...
                              <div className="banner-content banner-content-top ">
                                <h4 className="banner-subtitle text-white"><a href="#">you might love</a></h4>{/* End .banner-subtitle */}
                                <h3 className="banner-title text-white"><a href="#">This Week's <br />30% discounts</a></h3>{/* End .banner-title */}
                                <a href="#" className="banner-link">Shop Now <i className="icon-long-arrow-right" /></a>
                              </div>{/* End .banner-content */}
                            </div>{/* End .banner */}
                          </div>{/* End .col-sm-6 */}
                          <div className="col-sm-6">
                            <div className="banner banner-overlay">
                              ...
                              <div className="banner-content  banner-content-top banner-content-reverse">
                                <h4 className="banner-subtitle text-white"><a href="#">The new pretty</a></h4>{/* End .banner-subtitle */}
                                <h3 className="banner-title text-white"><a href="#">How To Dress<br />For Spring</a></h3>{/* End .banner-title */}
                                <a href="#" className="banner-link">Discover Now <i className="icon-long-arrow-right" /></a>
                              </div>{/* End .banner-content */}
                            </div>{/* End .banner */}
                          </div>{/* End .col-sm-6 */}
              ...
              <div className="container">
                <h2 className="title text-center">Currently Popular Items</h2>{/* End .title */}
                <ul className="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                  <li className="nav-item">
                    <a className="nav-link active" id="tab-new-link" data-toggle="tab" href="#tab-new" role="tab" aria-controls="tab-new" aria-selected="true">New</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" id="tab-featured-link" data-toggle="tab" href="#tab-featured" role="tab" aria-controls="tab-featured" aria-selected="false">Featured</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" id="tab-best-link" data-toggle="tab" href="#tab-best" role="tab" aria-controls="tab-best" aria-selected="false">Best Seller</a>
                  </li>
                </ul>
                    ...
                    <div className="row justify-content-center">
                      <div className="col-6 col-md-4 col-lg-3">
                        <div className="product product-4">
                          <figure className="product-media">
                            <a href="product.html">
                              <img src="assets/images/demos/demo-17/products/product-1.jpg" alt="Product image" className="product-image" />
                              <img src="assets/images/demos/demo-17/products/product-1-2.jpg" alt="Product image" className="product-image-hover" />
                            </a>
                      ...
                      <div className="col-6 col-md-4 col-lg-3">
                        <div className="product product-4">
                          <figure className="product-media">
                            ...
                            <a href="product.html">
                              <img src="assets/images/demos/demo-17/products/product-2.jpg" alt="Product image" className="product-image" />
                              <img src="assets/images/demos/demo-17/products/product-2-2.jpg" alt="Product image" className="product-image-hover" />
                            </a>
                            <div className="product-action-vertical">
                              <a href="#" className="btn-product-icon btn-wishlist btn-expandable"><span>add to wishlist</span></a>
                              <a href="popup/quickView.html" className="btn-product-icon btn-quickview" title="Quick view"><span>Quick view</span></a>
                      ...
                      <div className="col-6 col-md-4 col-lg-3">
                        <div className="product product-4">
                          <figure className="product-media">
                            <a href="product.html">
                              <img src="assets/images/demos/demo-17/products/product-3.jpg" alt="Product image" className="product-image" />
                              <img src="assets/images/demos/demo-17/products/product-3-2.jpg" alt="Product image" className="product-image-hover" />
                            </a>
                            <div className="product-action-vertical">
                              <a href="#" className="btn-product-icon btn-wishlist btn-expandable"><span>add to wishlist</span></a>
                              <a href="popup/quickView.html" className="btn-product-icon btn-quickview" title="Quick view"><span>Quick view</span></a>
                      ...
                      <div className="col-6 col-md-4 col-lg-3">
                        <div className="product product-4">
                          <figure className="product-media">
                            <a href="product.html">
                              <img src="assets/images/demos/demo-17/products/product-7.jpg" alt="Product image" className="product-image" />
                              <img src="assets/images/demos/demo-17/products/product-7-2.jpg" alt="Product image" className="product-image-hover" />
                            </a>
                            <div className="product-action-vertical">
                              <a href="#" className="btn-product-icon btn-wishlist btn-expandable"><span>add to wishlist</span></a>
                              <a href="popup/quickView.html" className="btn-product-icon btn-quickview" title="Quick view"><span>Quick view</span></a>
                      ...
                      <div className="col-6 col-md-4 col-lg-3">
                        <div className="product product-4">
                          <figure className="product-media">
                            <a href="product.html">
                              <img src="assets/images/demos/demo-17/products/product-4.jpg" alt="Product image" className="product-image" />
                              <img src="assets/images/demos/demo-17/products/product-4-2.jpg" alt="Product image" className="product-image-hover" />
                            </a>
                            <div className="product-action-vertical">
                              <a href="#" className="btn-product-icon btn-wishlist btn-expandable"><span>add to wishlist</span></a>
                              <a href="popup/quickView.html" className="btn-product-icon btn-quickview" title="Quick view"><span>Quick view</span></a>
                          ...
                          <div className="product-body">
                            ...
                            <div className="product-nav product-nav-dots">
                              <a href="#" className="active" style={{background: '#e3a84d'}}><span className="sr-only">Color name</span></a>
                              <a href="#" style={{background: '#f48a5b'}}><span className="sr-only">Color name</span></a>
                              <a href="#" style={{background: '#333333'}}><span className="sr-only">Color name</span></a>
                            </div>{/* End .product-nav */}
                          </div>{/* End .product-body */}
                        </div>{/* End .product */}
                      ...
                      <div className="col-6 col-md-4 col-lg-3">
                        <div className="product product-4">
                          <figure className="product-media">
                            <a href="product.html">
                              <img src="assets/images/demos/demo-17/products/product-5.jpg" alt="Product image" className="product-image" />
                              <img src="assets/images/demos/demo-17/products/product-5-2.jpg" alt="Product image" className="product-image-hover" />
                            </a>
                            <div className="product-action-vertical">
                              <a href="#" className="btn-product-icon btn-wishlist btn-expandable"><span>add to wishlist</span></a>
                              <a href="popup/quickView.html" className="btn-product-icon btn-quickview" title="Quick view"><span>Quick view</span></a>
                      ...
                      <div className="col-6 col-md-4 col-lg-3">
                        <div className="product product-4">
                          <figure className="product-media">
                            ...
                            <a href="product.html">
                              <img src="assets/images/demos/demo-17/products/product-6.jpg" alt="Product image" className="product-image" />
                              <img src="assets/images/demos/demo-17/products/product-6-2.jpg" alt="Product image" className="product-image-hover" />
                            </a>
                            <div className="product-action-vertical">
                              <a href="#" className="btn-product-icon btn-wishlist btn-expandable"><span>add to wishlist</span></a>
                              <a href="popup/quickView.html" className="btn-product-icon btn-quickview" title="Quick view"><span>Quick view</span></a>
                          ...
                          <div className="product-body">
                            ...
                            <h3 className="product-title"><a href="product.html">Linen-blend jumpsuit</a></h3>{/* End .product-title */}
                            <div className="product-price">
                              $595.00
                            </div>{/* End .product-price */}
                          </div>{/* End .product-body */}
                      ...
                      <div className="col-6 col-md-4 col-lg-3">
                        <div className="product product-4">
                          <figure className="product-media">
                            ...
                            <a href="product.html">
                              <img src="assets/images/demos/demo-17/products/product-8.jpg" alt="Product image" className="product-image" />
                              <img src="assets/images/demos/demo-17/products/product-8-2.jpg" alt="Product image" className="product-image-hover" />
                            </a>
                            <div className="product-action-vertical">
                              <a href="#" className="btn-product-icon btn-wishlist btn-expandable"><span>add to wishlist</span></a>
                              <a href="popup/quickView.html" className="btn-product-icon btn-quickview" title="Quick view"><span>Quick view</span></a>
                    ...
                    <div className="row justify-content-center">
                      ...
                      <div className="col-6 col-md-4 col-lg-3">
                        <div className="product product-4">
                          <figure className="product-media">
                            <a href="product.html">
                              <img src="assets/images/demos/demo-17/products/product-9.jpg" alt="Product image" className="product-image" />
                              <img src="assets/images/demos/demo-17/products/product-9-2.jpg" alt="Product image" className="product-image-hover" />
                            </a>
                            <div className="product-action-vertical">
                              <a href="#" className="btn-product-icon btn-wishlist btn-expandable"><span>add to wishlist</span></a>
                              <a href="popup/quickView.html" className="btn-product-icon btn-quickview" title="Quick view"><span>Quick view</span></a>
                    ...
                    <div className="row justify-content-center">
                      ...
                      <div className="col-6 col-md-4 col-lg-3">
                        <div className="product product-4">
                          <figure className="product-media">
                            <a href="product.html">
                              <img src="assets/images/demos/demo-18/products/product-9.jpg" alt="Product image" className="product-image" />
                              <img src="assets/images/demos/demo-18/products/product-9-2.jpg" alt="Product image" className="product-image-hover" />
                            </a>
                            <div className="product-action-vertical">
                              <a href="#" className="btn-product-icon btn-wishlist btn-expandable"><span>add to wishlist</span></a>
                              <a href="popup/quickView.html" className="btn-product-icon btn-quickview" title="Quick view"><span>Quick view</span></a>
              ...
              <div className="cta bg-image bg-dark pt-4 pb-5" style={{backgroundImage: 'url(assets/images/demos/demo-17/bg-1.jpg)'}}>
                <div className="container">
                  <div className="row justify-content-center">
                    <div className="col-sm-10 col-md-8 col-lg-6">
                      <div className="cta-heading text-center">
                        <h3 className="cta-title text-white">Sign up for email &amp; get 25% off </h3>{/* End .cta-title */}
              ...
              <div className="blog-posts">
                <div className="container">
                  <div className="heading text-center">
                    <h2 className="title">New Blog Posts</h2>{/* End .title */}
                    <p className="title-desc">Donec nec justo eget felis facilisis fermentum.</p>{/* End .title-desc */}
                  </div>{/* End .heading */}
                  <div className="owl-carousel owl-simple mb-4" data-toggle="owl" data-owl-options="{
                    ...
                    <article className="entry">
                      ...
                      <div className="entry-body">
                        <div className="entry-meta">
                          <a href="#">Nov 22, 2018</a><a>, 0 Comments
                          </a></div>{/* End .entry-meta */}<a>
                        </a><h3 className="entry-title"><a>
                          </a><a href="single.html">Aenean dignissim pellentesque felis.</a>
                        </h3>{/* End .entry-title */}
                        <div className="entry-content">
                          <a href="single.html" className="read-more">Read More</a>
                        </div>{/* End .entry-content */}
              ...
              <div className="container-fluid">
                <div className="heading text-center">
                  <h2 className="title">Follow us on instagram</h2>{/* End .title */}
                  <p className="title-desc">Donec nec justo eget felis facilisis fermentum.</p>{/* End .title-desc */}
                </div>{/* End .heading */}
