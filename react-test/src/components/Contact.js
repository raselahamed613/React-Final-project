                      ...
                      <form action="{{ route('message2')}}" method="post">
                        ...
                        <div className="row">
                          <div className="col-sm-6">
                            ...
                            <input type="text" className="form-control" id="cname" placeholder="Name *" name="c_name" />
                            
                          </div>{/* End .col-sm-6 */}
                          <div className="col-sm-6">
                            <label htmlFor="cemail" className="sr-only">Email</label>
                            <input type="email" className="form-control" id="cemail" placeholder="Email *" name="c_email" />
                        ...
                        <div className="row">
                          <div className="col-sm-6">
                            ...
                            <input type="tel" className="form-control" id="cphone" placeholder="Phone" name="c_phone" />
                            
                          </div>{/* End .col-sm-6 */}
                          <div className="col-sm-6">
                            <label htmlFor="csubject" className="sr-only">Subject</label>
                            <input type="text" className="form-control" id="csubject" placeholder="Subject" name="c_subject" />
                            
                          </div>{/* End .col-sm-6 */}
                        </div>{/* End .row */}
                        <label htmlFor="cmessage" className="sr-only">Message</label>
                        <textarea className="form-control" cols={30} rows={4} id="cmessage" name="c_message" placeholder="Message *" defaultValue={""} />
                      ...
                      <form action="{{ route('refand')}}" method="post">
                        ...
                        <div className="row">
                          <div className="col-sm-6">
                            ...
                            <input type="text" className="form-control" id="cname" placeholder="Type your Invoice*" name="invoice" />
                            
                          </div>{/* End .col-sm-6 */}
                          <div className="col-sm-6">
                            <label htmlFor="cemail" className="sr-only" />
                            <input type="text" className="form-control" id="cemail" placeholder="Type your pament Methode *" name="payment_method" />
                        ...
                        <div className="row">
                          <div className="col-sm-6">
                            ...
                            <input type="tel" className="form-control" id="cphone" placeholder="Type your mobile Number" name="phone" />
                           
                          </div>{/* End .col-sm-6 */}
                        </div>{/* End .row */}
                        <label htmlFor="cmessage" className="sr-only">Message</label>
                        <textarea className="form-control" cols={30} rows={4} id="cmessage" name="message" placeholder="Type your problem*" defaultValue={""} />
